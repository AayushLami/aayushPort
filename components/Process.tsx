          ...
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white border border-[#e5e5e5] rounded-xl p-[40px] flex flex-col items-center text-center gap-5 hover:border-[#d1d5db] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all duration-300 group"
              >
