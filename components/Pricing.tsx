    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1100px] mx-auto flex flex-col items-start text-left">
        ...
        <motion.div
          ...
          whileHover={{ y: -3 }}
          className="w-full bg-white rounded-[16px] px-[28px] py-[24px] flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left shadow-[0_1px_3px_rgba(0,0,0,0.07)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.1)] transition-all duration-200 ease-out cursor-default"
