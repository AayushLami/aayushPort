    ...
    <section id="pricing" className="py-32 px-6 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto">
          ...
          {pricingPlans.map((plan) => (
            <motion.div
              ...
              className={`
                ...
                ${
                  plan.popular
                    ? "bg-[#141414] border-white/25 shadow-[0_20px_60px_rgba(255,255,255,0.03)]"
            ...
            >
              ...
              <div className="flex flex-col gap-8 p-8 sm:p-10 flex-1">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-[#888888]">{plan.priceLabel}</span>
                </div>
                ...
                {/* Addon badge */}
                <div>
                  <span className="text-xs text-[#888888] border border-white/10 px-3 py-1.5 rounded-md inline-block">
                    {plan.addon}
                  </span>
                </div>
        ...
        <motion.p
          ...
          className="mt-12 text-center text-sm text-[#888888]"
        >
