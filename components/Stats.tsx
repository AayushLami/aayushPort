      ...
      >
        {stats.map((stat, i) => (
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="bg-white border border-[#e5e5e5] rounded-[16px] p-[40px] flex flex-col items-center justify-center text-center gap-2 hover:border-[#d1d5db] hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300"
          >
